...
local function decodeHeader( data, pos )
  ...
  --print("pos:")
  --print(pos)
  tmp, pos = string.unpack("<I4",data, pos )--"<I4",
  --print("tmp,pos:")
  --print(temp)
  --print(pos)
...
function decodeField1( data, pos )
  data1=string.pack( "s", data)
  local _
  local field = {}
  ...
  field.type, pos = string.unpack( "<s1s1s1s1s1s1BI2I4c6", data1, pos )
...
local function decodeHeader1( data, pos )
...
function sqlQuery( socket, query )
  ...
  --print(status)
  --print(fields)
  --print(string.len(rs.data))
  ssss=rs.data
  --print('this string is here')
  --status, rows = decodeDataPackets(ssss, field_count)
